...
public static partial class PacketSender
{
    ...
    internal static event Action<Player, long>? PetCooldownSent;
    ...
    public static void SendPetCooldown(Player player, long nextInvokeAtMs)
    {
        ...
        PetCooldownSent?.Invoke(player, nextInvokeAtMs);
   ...
   public static EquipmentPacket GenerateEquipmentPacket(Player forPlayer, Player en)
{
    ...
    public static void SendGameObjects(Client client, GameObjectType type, List<GameObjectPacket> packetList = null)
    {
        switch (type)
        {
            ...
            case GameObjectType.Sets:
                foreach (var obj in SetDescriptor.Lookup)
                {
                    SendGameObject(client, obj.Value, false, false, packetList);
                }
    ...
    {
        //SendChatMsg(player, message, ChatMessageType.Trade, color, target);
