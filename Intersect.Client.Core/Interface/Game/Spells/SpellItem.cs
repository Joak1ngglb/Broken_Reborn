...
public partial class SpellItem : SlotItem
{
        ...
        : base(parent, nameof(SpellItem), index, contextMenu)
    {
        ...
        _nameLabel.SetSize(120, 30);
        _nameLabel.SetPosition(40, 15);
        ...
        _levelUpButton.SetPosition(170, 10);   // al lado derecho del nombre
        _levelDownButton.SetPosition(191, 20);  // al lado izquierdo del nombre
