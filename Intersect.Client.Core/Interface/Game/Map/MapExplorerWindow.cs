...
public partial class MapExplorerWindow : WindowControl
{
    ...
    {
        var previousSelection = _selectedMapId;
        ...
        else
        {
            ...
            if (selectedRow != null)
            {
                _mapList.SelectedRow = selectedRow;
                _selectedMapId = previousSelection;
            }
            else
            {
                _selectedMapId = Guid.Empty;
