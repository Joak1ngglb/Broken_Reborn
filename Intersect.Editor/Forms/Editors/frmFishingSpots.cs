    ...
    public partial class FrmFishingSpots : EditorForm
    {
        ...
        private void UpdateEditor()
        {
            if (currentSpotEdit != null)
            {
                ...
                nudFishingJobExp.Value = currentSpotEdit.FishingJobExperience;
        ...
        private void nud_ValueChanged(object sender, EventArgs e)
        {
            ...
            currentSpotEdit.FishingJobExperience = (long)nudFishingJobExp.Value;
        }
        ...
        private void InitLocalization()
        {
            ...
            lblFishingJobExp.Text = Strings.FishingSpotEditor.fishingjobexp;
        }
