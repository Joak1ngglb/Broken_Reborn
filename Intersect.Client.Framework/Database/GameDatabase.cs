...
public abstract partial class GameDatabase
{
    ...
    public virtual void LoadPreferences()
    {
        ...
        ShowAchievementNotifications = LoadPreference(nameof(ShowAchievementNotifications), true);
    ...
    public virtual void SavePreferences()
    {
        ...
        SavePreference(nameof(ShowAchievementNotifications), ShowAchievementNotifications);
