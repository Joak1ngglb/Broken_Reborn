...
internal sealed class BuiltinControlsProvider : IControlsProvider
{
    ...
    private readonly Dictionary<Control, ControlMapping> _defaultMappings = new()
    {
        ...
        { Control.TargetParty1, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad1), ControlBinding.Default) },
        { Control.TargetParty2, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad2), ControlBinding.Default) },
        { Control.TargetParty3, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad3), ControlBinding.Default) },
        { Control.TargetParty4, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad4), ControlBinding.Default) },
        { Control.TargetParty5, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad5), ControlBinding.Default) },
        { Control.TargetParty6, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad6), ControlBinding.Default) },
        { Control.TargetParty7, new ControlMapping(new ControlBinding(Keys.None, Keys.NumPad7), ControlBinding.Default) },
